...
<head>
    ...
    <link rel="stylesheet" href="../style/user/detail.css" type="text/css">
...
<div class="container">
    ...
    <br>
    <img src="../Assets/img_data/<?php echo $baris['gambar']; ?>" alt="<?php echo $baris['nama_produk']; ?>" />
    ...
    <div class="back-button-container">
        <a href="infoJual.php" class="nav-button">Kembali</a>
    </div>
</div>
